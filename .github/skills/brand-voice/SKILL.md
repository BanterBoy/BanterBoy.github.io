...
- Write like a person talking, not a brand communicating
- British English throughout: colour, behaviour, organisation, whilst, licence (noun) etc.
- Contractions everywhere — it's, I'm, didn't, wasn't, shouldn't, he'd, you'll
- Personal context comes FIRST. Set the scene before making the point.
...
- Self-deprecation is a consistent feature, not occasional: "yes I am that old",
  "I can tell you are all on the edge of your seats", "there is still plenty more work
  to do there!"
- Never oversell, never use superlatives about own work
- Mild language is fine where it fits ("massive kick up the ass")
- Attribute and link generously — quote sources, credit others, link to further reading
- Ellipses (……) used mid-sentence for conversational pauses, not just at sentence ends
- Emoji used very sparingly and only where it adds something: 👌 ¯\_(ツ)/¯ 1️⃣
