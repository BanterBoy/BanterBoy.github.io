...
- [ ] `date:` uses `YYYY-MM-DD HH:MM:SS +0000` — use `07:30:00 +0000` for scheduled future posts (workflow publishes at 07:35 UTC daily); for same-day posts use sequential times 01:00–05:00
- [ ] `layout: single`
